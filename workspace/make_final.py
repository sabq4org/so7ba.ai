...
img1.save('/home/openclaw/.openclaw/workspace/final1.png')
...
d2.text((cx(d2, 'SOHBA', font_en), 400), 'SOHBA', fill='rgba(255,255,255,180)', font=font_en)
img2.save('/home/openclaw/.openclaw/workspace/final2.png')
...
img3.save('/home/openclaw/.openclaw/workspace/final3.png')
